...
const oldFetch = `                // Send parameters in both URL and Body to ensure public proxies don't strip them
...
const newFetch = `                const targetUrl = 'https://api.gumroad.com/v2/licenses/verify';
                const proxyUrl = \`https://corsproxy.io/?url=\${encodeURIComponent(targetUrl)}\`;
...
console.log('Patched product_id');
