...
fs.writeFileSync('scratch/FactBook.js', extractBlock(code, 'const FactBook ='));
fs.writeFileSync('scratch/Sidebar.js', extractBlock(code, 'const Sidebar ='));
fs.writeFileSync('scratch/App.js', extractBlock(code, 'const App = () => {'));
console.log('Extracted Sidebar, App, and FactBook');
