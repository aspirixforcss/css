...
fs.writeFileSync('scratch/LoginScreen.js', extractBlock(code, 'const LoginScreen ='));
fs.writeFileSync('scratch/Dashboard.js', extractBlock(code, 'const Dashboard ='));
fs.writeFileSync('scratch/Sidebar.js', extractBlock(code, 'const Sidebar ='));
fs.writeFileSync('scratch/App.js', extractBlock(code, 'export default function App()'));
fs.writeFileSync('scratch/CurrentAffairsView.js', extractBlock(code, 'const CurrentAffairsView ='));
