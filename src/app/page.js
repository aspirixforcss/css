        ...
        <div className="w-72 h-full bg-white dark:bg-surfaceDark border-r border-slate-200 dark:border-slate-800 flex flex-col transition-colors z-20 font-sans shadow-[4px_0_24px_rgba(0,0,0,0.02)] dark:shadow-none">
            <div className="p-6 border-b border-slate-100 dark:border-slate-800/50">
                <div className="flex items-center gap-3">
                    ...
                    <div className="w-40 h-10 bg-white dark:bg-white drop-shadow-sm" style={{ WebkitMaskImage: `url(${aspirixText})`, WebkitMaskSize: 'contain', WebkitMaskRepeat: 'no-repeat', WebkitMaskPosition: 'center', maskImage: `url(${aspirixText})`, maskSize: 'contain', maskRepeat: 'no-repeat', maskPosition: 'center' }} />
                </div>
            </div>
            ...
            <div className="p-4 mt-auto border-t border-slate-100 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-900/20">
                <div className="flex items-center gap-3 mb-4 p-2">
                    ...
                    <button className="w-8 h-8 rounded-full bg-white dark:bg-slate-800 flex items-center justify-center text-slate-400 hover:text-primary shadow-sm border border-slate-200 dark:border-slate-700 transition-colors">
                        <i className="fa-solid fa-gear"></i>
                    </button>
                </div>
                <button onClick={() => signOut(auth)} className="w-full flex items-center justify-center gap-2 text-sm font-bold text-slate-400 hover:text-red-500 py-2 transition-colors">
                    <i className="fa-solid fa-right-from-bracket"></i> Sign Out
                </button>
            </div>
            
            <button onClick={toggleTheme} className="absolute bottom-6 right-6 w-12 h-12 bg-white dark:bg-slate-800 rounded-full shadow-lg border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-600 dark:text-yellow-400 hover:scale-110 transition-all z-50">
...
const Dashboard = ({ targetYear, selectedSubjects, completedTopics, openTimer, dailyStreak, user }) => {
    ...
    return (
        <div className="max-w-6xl mx-auto p-4 md:p-8 animate-fade-in pb-32 w-full font-sans">
            ...
            {/* Big AI Analysis Box */}
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 dark:from-slate-800 dark:to-slate-950 p-8 rounded-[2rem] shadow-xl text-white mb-16 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="bg-white/10 border border-white/20 p-5 rounded-2xl backdrop-blur-sm">
